...
struct Node{
    ...
    //Deleting element at given node
...
int main(){
    ...
    //Allocating memmory for nodes dynamically i.e dynamically allocated memory is found in heaps not in stack
